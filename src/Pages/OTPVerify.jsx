...
const OTPVerify = () => {
  ...
  return (
    <div className="flex flex-col justify-between h-full gap-16 sm:gap-10">
      <div>
        <div className="text-2xl font-semibold text-black">Verifying you 👁</div>
      ...
      <div className="flex flex-col gap-10">
        <div className="flex flex-col gap-2 pb-3">
          ...
          <div className="relative">
            ...
            <div className="absolute left-0 right-0 top-0 bottom-0 z-10 flex gap-2">
              <div className="h-full" style={{ width: "100%" }}>
                <label
                  htmlFor="otp"
                  className={`bg-white h-full w-full border-2 border-solid flex justify-center items-center text-xl rounded-xl ${
                    otp.length === 0 ? `border-${color}` : "border-black/20"
                  }`}
                >
                  {otp.split("")[0]}
                </label>
              ...
              <div className="h-full" style={{ width: "100%" }}>
                <label
                  htmlFor="otp"
                  className={`bg-white h-full w-full border-2 border-solid flex justify-center items-center text-xl rounded-xl ${
                    otp.length === 1 ? `border-${color}` : "border-black/20"
                  }`}
                >
                  {otp.split("")[1]}
                </label>
              ...
              <div className="h-full" style={{ width: "100%" }}>
                <label
                  htmlFor="otp"
                  className={`bg-white h-full w-full border-2 border-solid flex justify-center items-center text-xl rounded-xl ${
                    otp.length === 2 ? `border-${color}` : "border-black/20"
                  }`}
                >
                  {otp.split("")[2]}
                </label>
              ...
              <div className="h-full" style={{ width: "100%" }}>
                <label
                  htmlFor="otp"
                  className="bg-white flex justify-center items-center h-full w-full  text-xl"
                >
                  -
                </label>
              </div>
              <div className="h-full" style={{ width: "100%" }}>
                <label
                  htmlFor="otp"
                  className={`bg-white h-full w-full border-2 border-solid flex justify-center items-center text-xl rounded-xl ${
                    otp.length === 3 ? `border-${color}` : "border-black/20"
                  }`}
                >
                  {otp.split("")[3]}
                </label>
              ...
              <div className="h-full" style={{ width: "100%" }}>
                <label
                  htmlFor="otp"
                  className={`bg-white h-full w-full border-2 border-solid flex justify-center items-center text-xl rounded-xl ${
                    otp.length === 4 ? `border-${color}` : "border-black/20"
                  }`}
                >
                  {otp.split("")[4]}
                </label>
          ...
          <button className="text-blue-600 text-xs text-left">
            Having trouble ?{" "}
            <span className="font-semibold to-blue-950">Resend it now</span>
          </button>
        </div>
      ...
      <div>
        ...
        <span className="text-sm">
          ...
          <Link to="/login">
            <span className="text-yellow-600 text-sm"> Login now.</span>
          </Link>
        </span>
      </div>
    </div>
