      ...
      <section className="lg:w-4/6 min-[200px]:w-full h-full px-4 flex flex-col overflow-y-auto">
        <div className="w-full relative flex flex-col gap-2">
          ...
          <div className="w-full rounded-xl overflow-hidden relative">
            <div className="w-full h-full absolute opacity-0 hover:opacity-100 transition-all hidden sm:block duration-700">
              <div
                className={`absolute left-0 h-full w-40 top-0  rounded-l-xl  transition-all duration-700 ease-in-out`}
              >
                <button
                  className="text-white h-full p-2 w-40 bg-gradient-to-r from-brand-dark-blue/30  hover:from-brand-dark-blue duration-800 delay-500 ease-in-out"
                ...
                >
                  <svg
                    ...
                    strokeWidth={2}
                    stroke="currentColor"
                    className="w-8 h-8 hover:rotate-180 hover:scale-[1000%] duration-700"
                  >
                    <path
                      strokeLinecap="round"
              ...
              <div
                className={`absolute right-0 h-full w-40 top-0  rotate-180 transition-all duration-700 ease-in-out`}
              >
                <button
                  className="text-white h-full p-2 w-40 bg-gradient-to-r from-brand-dark-blue/30 to-transparent rounded-l-xl duration-700 hover:from-brand-dark-blue"
            ...
            <div
              className="w-full overflow-x-auto customscroll scroll-smooth"
              ref={ref}
            >
